...
# Food Dose Tiffin Service's fixed weekly menu (Karol Bagh, New Delhi)
ITEMS = [
    ("lunch-monday", "Monday Lunch Thali", 110, ("#fbe9d7", "#f6cfa8", "#fff", ["#8d3b1f", "#e8c37a", "#d94f2a"])),
    ("dinner-monday", "Monday Dinner Thali", 110, ("#fdeede", "#f7c9a0", "#fff", ["#d9662e", "#f2d17c", "#8a3a1c"])),
    ("lunch-tuesday", "Tuesday Lunch Thali", 130, ("#fbeecd", "#efd39b", "#fff", ["#e6b84a", "#c9772b", "#7fae4e"])),
    ("dinner-tuesday", "Tuesday Dinner Thali", 110, ("#fde9d0", "#f3c893", "#fff", ["#7a3b1e", "#e7c07d", "#c1521f"])),
    ("lunch-wednesday", "Wednesday Lunch Thali", 120, ("#fbe7c9", "#eccf96", "#fff", ["#e8c065", "#c98a34", "#9c5a24"])),
    ("dinner-wednesday", "Wednesday Dinner Thali", 110, ("#fbe2cf", "#f0bd94", "#fff", ["#b8401f", "#e8a95e", "#6f2c16"])),
    ("lunch-thursday", "Thursday Lunch Thali", 110, ("#f7ead0", "#e6cf9c", "#fff", ["#7fae4e", "#d9822b", "#c53f2c"])),
    ("dinner-thursday", "Thursday Dinner Thali", 120, ("#eef0d3", "#cdd79b", "#fff", ["#3f6b3a", "#e7d9a8", "#a7c65f"])),
    ("lunch-friday", "Friday Lunch Thali", 120, ("#fbe9d7", "#f6cfa8", "#fff", ["#7fae4e", "#e8c37a", "#d94f2a"])),
    ("dinner-friday", "Friday Dinner Thali", 110, ("#fdeede", "#f7c9a0", "#fff", ["#e6b84a", "#f2d17c", "#8a3a1c"])),
    ("lunch-saturday", "Saturday Lunch Thali", 130, ("#fbeecd", "#efd39b", "#fff", ["#d9662e", "#c9772b", "#f9b024"])),
    ("dinner-saturday", "Saturday Dinner Thali", 130, ("#fde9d0", "#f3c893", "#fff", ["#7a3b1e", "#e7c07d", "#c1521f"])),
    ("lunch-sunday", "Sunday Lunch Thali", 120, ("#fbe7c9", "#eccf96", "#fff", ["#e8c065", "#c98a34", "#9c5a24"])),
    ("dinner-sunday", "Sunday Dinner Thali", 140, ("#fbe2cf", "#f0bd94", "#fff", ["#b8401f", "#e8a95e", "#6f2c16"])),
]
...
def food_svg(title: str, price: int, palette) -> str:
  ...
  <text x="28" y="428" font-family="Arial, sans-serif" font-size="14" fill="#f6cfa8">Food Dose &#183; homestyle</text>
